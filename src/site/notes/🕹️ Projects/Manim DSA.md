...
Before this project, I had already experimented with my own [[🕹️ Projects/Algorithm Visualizer\|Algorithm Visualizer]] in Godot, but like other existing algorithm visualizers, it's limited to predefined algorithms (only one actually 😩) and not customizable. Manim DSA solves this by giving users flexibility to animate any algorithm or data structure.
