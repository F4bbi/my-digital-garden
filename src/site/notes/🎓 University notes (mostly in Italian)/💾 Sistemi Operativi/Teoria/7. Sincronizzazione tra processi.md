...
Per risolvere questi problemi sono stati introdotti i [[#Semafori|semafori]], ovvero variabili intere (o binarie nel caso dei mutex o semafori binari) che i processi condividono e che sono modificabili solo attraverso le sopracitate operazioni atomiche.
...
#### Implementazione con busy waiting
Di seguito è riportata una possibile implementazione che soffre di busy waiting. Questo perchè $P$ e $V$ sono implementati usando la [[#implementazione con busy waiting|swap]].
